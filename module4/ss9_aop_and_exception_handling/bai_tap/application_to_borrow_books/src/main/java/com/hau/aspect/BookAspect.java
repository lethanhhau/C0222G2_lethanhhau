...
public class BookAspect {
    ...
    @AfterReturning(pointcut = " execution(public * com.hau.controller.BookController.*(..)) ")
    public void logHistory(JoinPoint joinPoint) {
        String name = joinPoint.getSignature().getName();
        System.out.println("The " + name + " method just worked");
    }

    @After(" execution(public * com.hau.controller.BookController.goHome(..)), && args(showDetail(..)) ")
