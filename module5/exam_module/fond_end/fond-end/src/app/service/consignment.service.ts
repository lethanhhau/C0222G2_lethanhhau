...
export class ConsignmentService {
  ...
  getAllConsignment(searchProductName: string, page: number): Observable<Consignment[]> {
    return this.httpClient.get<Consignment[]>(this.URL_CONSIGNMENT + '/page?page=' + page + '&keyWord=' + searchProductName);
  }
  ...
  editLoHang(consignment: Consignment): Observable<Consignment> {
